                    ...
                    <div class="filter-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control zip-width"  placeholder="Name" type="text" value="{{request()->query('name')}}" name="name">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="filter-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" value="{{request()->query('description')}}" name="description">
                            </div>
                        </div>
                    </div>
                </div>
